<template>
  <section id="quality-challenges">
    <div class="quality-challenges-section-text text-content">
      ...
      <h3>Taken alone, <i>enough</i> water is not enough – it needs to be of sufficient quality, too. </h3>
