<template>
  ...
  >
    <div class="quality-challenges-section-text text-content">
      ...
      <p>In the rest of this story, we’ll dive into two water-quality variables that have drawn recent attention – salinity and temperature – and a new USGS monitoring program that is improving our ability to provide the data needed to manage both the quantity and the quality of water in the Delaware River.</p>
    </div>
  </section>
</template>
