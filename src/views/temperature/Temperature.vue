    ...
    <div id="temp-wrapper">
      <div id="temp-image-wrapper">
        <div id="temp-image-container">
          <!-- Begin Trout -->
          <div class="right" id="trout-images">
          ...
          >
            ...
            >
              ...
              <div
                ...
                style=" margin-top: -5%;"
              >
                <p class="scrolly-chunk">Dwarf wedgemussels, an endangered species, have their own preferences for water temperatures and river flow rates, preferences that are distinctly different than brook trout. Wedgemussels like to live in <span class="emph">warmer water</span> than the brookies do.</p>
                <p class="scrolly-chunk">That’s why reservoir release decisions are such an important management tool.</p>
                <p class="scrolly-chunk">Reservoir water stays cool. When managers release reservoir water, the release sends an extra rush of cool reservoir water downstream.  With the right data and monitoring, managers can make sure that release decisions to maintain enough flow also keep water temperature in a healthy range for the species that live there.</p>
              </div>
              <!-- End Mussels Text -->

              <!-- Begin Mussels Images -->
              <!-- <div
                v-show="isMusselsTextInView"
                class="image-stack"
              >
