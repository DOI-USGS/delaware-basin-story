    ...
    <div id="salinity-sea-container">
      <div class="salinity-sea-section-image">
        <div id="container-salinity-sea-image-background">
          ...
          >
            <defs>
             <!--  <linearGradient id="saltysalt">
                <stop class="stop1" offset="0%" />
                <stop class="stop1" offset="51%" />
                <stop class="stop2" />
                <stop class="stop3" offset="63%" />
...
#salty-water  {
  ...
  opacity: 0.9;
  clip-path: square;
  animation: salt-mvmt 12s linear infinite;
}/* 
#salty-mix  {
  fill: url(#Gradient1);  
}
...
.stop2  { 
  stop-color: yellow; 
  stop-opacity: 0.5; 
  animation: salt-fade 12s linear infinite;
  }
.stop3  { 
  stop-color: blue; 
  }
