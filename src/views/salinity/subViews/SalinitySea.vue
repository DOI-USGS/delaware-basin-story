        ...
        <div id="container-salinity-sea-image-background">
          ...
          >
            ...
            <g v-if="SeasonalChanges">
              ...
              <g id="drought" class="marker"  >
              <g id="drought_t" class="marker" >
                <path d="M820.76 240.48l15.24-2.41M827.19 263.79c.24-7.77.51-14.74.8-24.11"/>
              </g>
              <path id="drought_r" class="marker" d="M718 260.14a28.08 28.08 0 01-1.6-15.27 17.5 17.5 0 014.82-.81 14 14 0 017.23 1.61c1 .58 2.46 1.4 2.41 2.41 0 .42-.31.93-3.21 2.41-2.31 1.18-3.9 1.76-6.39 2.88-1.06.47-1.91.88-2.45 1.14l7.23 4.82"/>
              <path id="drought_d" class="marker" d="M688.27 245.27c0 2.45-.82 9.79.82 14.69a55.69 55.69 0 008.15-3.27 38.66 38.66 0 007.35-4.89c1.36-1.05 3.3-2.83 3.26-4.08 0-.52-.4-1.42-2.45-2.45-5.12-2.57-14.16-2.57-17.9-2.48"/>
              <path id="drought_s" class="marker" d="M672 245.29a22.28 22.28 0 00-11 0c-2.12.56-7.11 2.24-7 4 .17 2.77 12.71 2.82 13 6 .16 1.73-3.37 3.43-5 4a10.87 10.87 0 01-7 0"/>
              <path id="drought_1" class="marker" d="M577 250.29l10-6q-.5 9.51-1 19"/>
              <path id="drought_9" class="marker" d="M604 261.29c.78-2.47 1.44-4.82 2-7 .51-2 1.09-4.43 1.66-7.25.14-.71.26-1.31.34-1.75a26.36 26.36 0 00-6 2c-2.65 1.27-6.09 2.91-6 5 .07 1.49 1.88 2.59 3 3a6.75 6.75 0 007-2"/>
              <path id="drought_6" class="marker" d="M624 239.29c-.72.91-1.78 2.28-3 4-2.37 3.36-3.56 5.08-4 7-.28 1.24-1 4.57 1 7 1.22 1.47 3.68 2.88 6 2 2.5-.94 4.11-4.27 3-6a3.35 3.35 0 00-4-1 3.5 3.5 0 00-2 3"/>
              <path id="drought_0" class="marker" d="M642 243.29c-3.08-.7-6 2.44-7 5-1.22 3-.83 7.57 2 9 2.63 1.33 5.78-.84 6-1a7.71 7.71 0 003-6 5.71 5.71 0 00-1-4c-1.91-2.26-6.54-2.3-9 0-3.24 3-2.13 9.54 1 11s8.13-1.73 9-6c.63-3.11-.91-7.29-4-8z"/>
              <path id="drought_o" class="marker" d="M743.15 258.79c3.15-.65 4.86-4.25 5-6.68.18-2.86-1.67-6.3-4.82-6.33-2.93 0-5.2 2.92-5.36 3.13a6.24 6.24 0 00-.89 5.91 4.23 4.23 0 002.25 2.77c2.54 1 6.93-.73 8.52-3.51 2.09-3.66-1.08-8.36-4.52-8.3s-7.14 4.54-6.58 8.25c.43 2.7 3.25 5.4 6.4 4.76z"/>
              <path id="dought_u" class="marker" d="M758 245.29a29.85 29.85 0 00-1 5c-.37 3.41-.73 6.66 1 8s4.77.1 5 0c6.25-2.7 6-14.4 6-15"/>
              <path id="drought_g" class="marker" d="M788 243.29a13.54 13.54 0 00-7 3c-.78.67-5.35 4.7-4 8 1 2.49 4.79 3.12 7 3 4.86-.26 7.64-4.43 8-5l-8-1"/>
              <g id="drought_h" class="marker">
                <path d="M800 246.29q.5 6.51 1 13M814 243.29v18M803 255.29l10-1"/>
              </g>
              <path class="marker" d="M688 245.29a39.65 39.65 0 001 13 44 44 0 0013-6c4.54-3.1 5.1-4.84 5-6a4.63 4.63 0 00-2-3c-5.21-4.18-15.38-2.48-18-2"/>
            </g>
...
#drought_arrow {
    .animation(@name: ghostwrite-50, @duration: @write-time, @delay: @start+(@delay-time*2));
  }
#drought_1 {
    .animation(@name: ghostwrite-50, @duration: @write-time, @delay: @start+(@delay-time*2));
  }
#drought_9 {
    .animation(@name: ghostwrite-50, @duration: @write-time, @delay: @start+(@delay-time*3));
  }
#drought_6 {
...
#drought_t {
    .animation(@name: ghostwrite-50, @duration: @write-time, @delay: @start+(@delay-time*13));
  }
